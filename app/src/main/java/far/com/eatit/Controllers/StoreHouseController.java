...
public class StoreHouseController {
    ...
    private static StoreHouseController instance;
    private StoreHouseController(Context c){
        this.context = c;
        db = FirebaseFirestore.getInstance();
    }
    public static StoreHouseController getInstance(Context c){
        if(instance == null){
            instance = new StoreHouseController(c);
        }
        return instance;
    }
    ...
    public CollectionReference getReferenceFireStore(){
        ...
        CollectionReference reference = db.collection(Tablas.generalUsers).document(l.getCODE()).collection(Tablas.generalUsersStoreHouse);
        return reference;
    }

    public long insert(StoreHouse r){
    ...
    public long update(StoreHouse r, String where, String[] args){
        ContentValues cv = new ContentValues();
        cv.put(CODE,r.getCODE() );
        cv.put(DESCRIPTION,r.getDESCRIPTION());
        cv.put(MDATE, Funciones.getFormatedDate(r.getMDATE()));
    ...
    public ArrayList<StoreHouse> getStoreHouses(String[] camposFiltros, String[]argumentos, String campoOrderBy){

        ArrayList<StoreHouse> result = new ArrayList<>();
    ...
    public void fillSpinner(Spinner spn){
        ArrayList<StoreHouse> result = getStoreHouses(null, null, null);
        ArrayList<KV> spnList = new ArrayList<>();

        for(StoreHouse r : result){
    ...
    public void getDataFromFireBase(String key, OnSuccessListener<QuerySnapshot> onSuccessListener,
        ...
        Task<QuerySnapshot> areas = db.collection(Tablas.generalUsers).document(key).collection(Tablas.generalUsersStoreHouse).get();
                ...
                public void onSuccess(QuerySnapshot querySnapshot) {
                    if(querySnapshot != null && querySnapshot.getDocumentChanges()!= null && !querySnapshot.getDocumentChanges().isEmpty()){
                        for(DocumentChange dc : querySnapshot.getDocumentChanges()) {
                            StoreHouse object = dc.getDocument().toObject(StoreHouse.class);
                            String where = CODE+" = ?";
