...
public class LicenseController  {
    ...
    public long insert(Licenses l){
        ...
        cv.put(DATEINI, Funciones.getFormatedDate(l.getDATEINI()));
        cv.put(DATEEND, Funciones.getFormatedDate(l.getDATEEND()));
        cv.put(DAYS, l.getDAYS());
        cv.put(COUNTER, l.getCOUNTER());
        cv.put(UPDATED, l.isUPDATED());
        cv.put(STATUS, l.getSTATUS());
        cv.put(LASTUPDATE, Funciones.getFormatedDate(l.getLASTUPDATE()));
    ...
    public int updateLicenciaDiaria(String fechaActual){
        ...
        if(l != null  &&  l.getLASTUPDATE() != null
                && !Funciones.getFormatedDate(l.getLASTUPDATE()).equals(fechaActual)) {//ya habia realizado una carga inicial y la fecha de ultima actualizacion es diferente
            l.setLASTUPDATE(Funciones.parseStringToDate(fechaActual));
            l.setCOUNTER(Funciones.calcularDias(fechaActual, Funciones.getFormatedDate(l.getDATEINI())));
            l.setUPDATED(false);
